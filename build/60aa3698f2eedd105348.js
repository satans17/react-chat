	...
	var App = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      "div",
	      { className: "app" },
	      React.createElement(Header, { title: "React Chat" }),
	      React.createElement(
	        Scroller,
	        { ref: "scroller" },
	        React.createElement(List, { ref: "list", insert: this.sync })
	      ),
	      React.createElement(Form, { submit: this.submit })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      "div",
	      { ref: "wrapper", className: "mod-page-body" },
	      React.createElement(
	        "div",
	        null,
	        this.props.children
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  handlePlugin: function handlePlugin(ev) {
	    ev.preventDefault();
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      "div",
	      { className: "mod-page-footer" },
	      React.createElement(
	        "div",
	        { className: "mod-input-form" },
	        React.createElement(
	          "div",
	          { className: "fields textarea" },
	          React.createElement("textarea", { ref: "input", className: "textarea" })
	        ),
	        React.createElement(
	          "div",
	          { className: "fields plugins" },
	          React.createElement(
	            "button",
	            { className: "btn", onClick: this.handlePlugin },
	            "Pulgin"
	          )
	        ),
	        React.createElement(
	          "div",
	          { className: "fields submit" },
	          React.createElement(
	            "button",
	      ...
	      React.createElement(Plugins, { ref: "plugins", display: "0" })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      "div",
	      { className: "message mod-chat-item right" },
	      React.createElement(
	        "div",
	        { className: "user" },
	        React.createElement(
	        ...
	        React.createElement(Avatar, { src: message.avatar, alt: message.nick })
	      ),
	      React.createElement(
	        "div",
	        { className: "chat" },
	        React.createElement("s", { className: "arrow" }),
	        React.createElement(
	          "div",
	          { className: "body" },
	          React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement("div", { style: style, className: "mod-input-plugins" });
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  handlerError: function handlerError(ev) {
	  ...
	  render: function render() {
	    return React.createElement(
	      "div",
	      { className: "avatar" },
	      React.createElement("img", { src: this.props.img, alt: this.props.alt, onError: this.handlerError })
	    );
	  }
	});
